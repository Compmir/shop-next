            ...
            <div className="modal__dialog">
                <div className="modal__content">
                        ...
                        <form onSubmit={handleSubmit(submitHandler)} id="form">
                            ...
                            <input style={{marginTop: "14px"}} {...register("name", {required: false})} placeholder="Ваше имя (необязательно)" name="name" type="text" className="modal__input"></input> 
                            <input {...register("message", {required: false})} placeholder="Сообщение (необязательно)" name="message" type="text" className="modal__input"></input> 
                            <button type="submit" className="modal__btn">Отправить</button>
                            <div className="delivery__form-item">
                            <div className="delivery__form-checkbox">
                                    <input {...register("agreement", {required: true})} id="formAgreement" checked type="checkbox" className="delivery__checkbox-input"></input>
