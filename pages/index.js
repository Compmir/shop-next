                ...
                <div className="intro__wrapper">
                    <div className="intro__left">
                        ...
                        <div className="intro__btns">
                            <button className="intro__btn" onClick={() => setModalShowStatus(true)}>Задать вопрос менеджеру</button>
                ...
                <div className="sale__wrapper">
                    <div>
                        ...
                        <div className="sale__link">
                                <Link href="/catalog/categories/0" ><a className='sale__link-text'> Перейти в каталог </a></Link>
                        </div>
                    </div>
                </div>
            </div>
