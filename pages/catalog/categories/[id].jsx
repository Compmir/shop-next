    ...
    return (
      ...
      <div className="container">
          <div className="breadcrumbs">
              ...
              <Link href="/catalog/categories/0" ><a className="breadcrumbs__item">Категории</a></Link>
			  -  <a onClick={router.back} style={{cursor: 'pointer'}} className="breadcrumbs__item">Назад</a>
              </div>  
          ...
          <div className="catalog__wrapper">
              {
                  goods.map((element, index) => {
                      return (
						...
						<Image width="384px" height="256px" src={element["image"]} alt={element.name}  />
                        </div>
...
export const getServerSideProps = async (context) => {
	...
	//new categories from prisma/client
...
/* 	for (var key in categoriesResponse) {
		
	   console.log(key + ': ' + categoriesResponse[key]);
    } */
//	console.log('cr',categoriesResponse)
	
    //  categoriesResponse = (await axios.get(`https://trade-group.su/apicategories?parent=${id}`)).data
