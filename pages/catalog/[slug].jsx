          ...
          <div className="container">
            ...
            <div className="product-card__wrapper">
              <div className="product-card__img-box">
                ...
                <div style={{ width: '100%', marginLeft: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div className="product-card__content">
                ...
                <div className="product-card__tabs">
                  ...
                  <div className="product-card__tabs-catalog characteristic">
                        ...
                        .map((element, index) => {
                          ...
                          return (
                            <div key={index} className="product-card__tabs-catalog-item bottom-line">
                              <div className="product-card__tabs-catalog-item-left">{property + ':'}</div>
                              <div className="product-card__tabs-catalog-item-right">
                                {isFile(value) ? (
                                  <a rel="noreferrer" target={'_blank'} href={'http://trade-group.su' + value} className="characteristic-show-more">
                                    Скачать
                                  </a>
                                ) : (
                                  value
                    ...
                    <a onClick={() => setShowMore((status) => !status)} className="characteristic-show-more">
                  ...
                  <div className="product-card__tabs-catalog addinfo hide">
                    <div className="product-card__tabs-catalog-item">
                      <div className="product-card__tabs-catalog-item-addinfo">
                        ...
                        possimus at vel debitis quidem molestiae beatae mollitia. Aliquid molestiae sequi reprehenderit blanditiis provident earum, accusantium reiciendis!
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        <span>Lorem ipsum dolor</span>, sit amet consectetur adipisicing elit. Modi et cumque nulla! Ipsa sunt accusamus natus tempore ea illo ad ipsam facilis sint, quae eos reiciendis, voluptatem eius nihil exercitationem voluptates ratione aspernatur officiis ab non. Ullam, odit,
